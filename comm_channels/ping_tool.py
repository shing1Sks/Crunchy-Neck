...
from .ping_types import PingParams, PingResult, PingResultError
...
def _dispatch_terminal(params: PingParams) -> PingResult:
    from .terminal.channel import terminal_send
...
def _dispatch_telegram(
    ...
    from .telegram.config import ConfigError, load_config
